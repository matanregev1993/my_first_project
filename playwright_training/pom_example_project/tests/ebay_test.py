...
from playwright_training.pom_example_project.page.adv_page import AdvPage
from playwright_training.pom_example_project.page.search_page import SearchPage
from playwright_training.pom_example_project.globals import URL, ITEM_TO_FIND
class TestEbayTest:
